...
<body>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="images/logo.jpg" alt="" class="circle responsive-img valign profile-image">
                </div>
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2020 <a class="grey-text text-lighten-4" href="#" target="_blank">SASA</a> All rights reserved.</span>
        <span class="right"> Designed and Developed by <a class="grey-text text-lighten-4" href="#">SASA</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
